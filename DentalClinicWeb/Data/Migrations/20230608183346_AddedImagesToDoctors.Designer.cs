...
namespace DentalClinicWeb.Data.Migrations
{
    ...
    [Migration("20230608183346_AddedImagesToDoctors")]
    partial class AddedImagesToDoctors
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DentalClinicWeb.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DentalClinicWeb.Models.AppointmentViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("EndAppointmentDateTime")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool>("TreatmentEnabled")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DentalClinicWeb.Models.SMS", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DentalClinicWeb.Models.AppointmentViewModel", b =>
                {
                    b.HasOne("DentalClinicWeb.Models.DoctorViewModel", "Doctors")
                        .WithMany()
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DentalClinicWeb.Models.PatientViewModel", "Patients")
                        .WithMany()
                        .HasForeignKey("PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DentalClinicWeb.Models.TreatmentsViewModel", "Treatment")
                        .WithMany()
            ...
            modelBuilder.Entity("DentalClinicWeb.Models.NotificationModel", b =>
                {
                    b.HasOne("DentalClinicWeb.Models.AppointmentViewModel", "Appointment")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DentalClinicWeb.Data.ApplicationUser", null)
                        .WithMany()
